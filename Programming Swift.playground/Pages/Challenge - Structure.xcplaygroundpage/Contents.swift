...
struct Restaurant {
    ...
    func willOverlaps(restuarant : Restaurant) -> Bool {
        return self.deliveryDistance + restuarant.deliveryDistance >= self.location.getDistance(restuarant.location)
...
restaurant1.willOverlaps(restuarant: restaurant2)
...
restaurant3.willOverlaps(restuarant: restaurant4)
